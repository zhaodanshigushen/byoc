var App = function () {
	...
	var handleDataTables = function () {
		$('#datatable2').dataTable({
                ...
                oTableTools: {
                    ...
                    sSwfPath: "resource/js/datatables/extras/TableTools/media/swf/copy_csv_xls_pdf.swf"
                }
			});
	...
	var handleTimeline = function () {
		createStoryJS({
			...
			width:		'100%',
			height:		'600',
			source:		'resource/js/timelinejs/example_json.json',
			embed_id:	'my-timeline',
			debug:		true,
			css:        'resource/js/timelinejs/css/timeline.css',
            js:         'resource/js/timelinejs/js/timeline-min.js'
		});
	}
	/*-----------------------------------------------------------------------------------*/
	/*	Handle Slidernav
	...
	var handleSliderNav = function () {
		...
		$('#address-book .slider-content ul li ul li a').click(function(e){
			...
			//Set the image
			$('#contact-card .headshot img').attr('src', 'resource/img/addressbook/'+img_id+'.jpg');
	...
	var handleThemeSkins = function () {
        ...
        var setSkin = function (color) {
            $('#skin-switcher').attr("href", "ui/css/themes/" + color + ".css");
